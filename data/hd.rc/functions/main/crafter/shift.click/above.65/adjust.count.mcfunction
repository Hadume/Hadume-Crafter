...
## 調整するための準備
	execute store result score $HdRc.Give.Result HdRc.Temp run data get entity @e[type=minecraft:marker,tag=HdSctThis,distance=..0.001,limit=1] data.Using.Recipe.Result.Count
