#> hd.sct:recipe_maker/check
#
# 
#
# @within function hd.sct:recipe_maker/
...
## 
	execute if data storage hd.sct:temp ItemsCopy[{Slot:15b}] run function hd.sct:recipe_maker/result
## 
