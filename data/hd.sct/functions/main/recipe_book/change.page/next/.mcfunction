#> hd.sct:main/recipe_book/change.page/next/
#
# 次のページへ
#
...
## 
	execute unless data storage hd.sct:temp PageCopy[] if data storage hd.sct:recipe_book NotYet[] run function hd.sct:main/recipe_book/change.page/next/make.page
## 
