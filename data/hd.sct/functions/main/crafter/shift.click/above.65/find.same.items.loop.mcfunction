#> hd.sct:main/crafter/shift.click/above.65/find.same.items.loop
#
# 
#
...
## 
	execute if data storage hd.sct:temp InventoryCopy[] run function hd.sct:main/crafter/shift.click/above.65/find.same.items.loop
