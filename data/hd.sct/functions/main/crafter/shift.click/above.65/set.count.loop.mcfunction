#> hd.sct:main/crafter/shift.click/above.65/set.count.loop
#
# アイテムのCountを決める
#
...
## まだ渡せたらループ
	execute if score $HdSct.Result.Count HdSct.Temp matches 1.. if data storage hd.sct:temp SameItems[] run function hd.sct:main/crafter/shift.click/above.65/set.count.loop
