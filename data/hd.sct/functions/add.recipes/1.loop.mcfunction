...
## リストの大きさを取得
	execute if data storage hd.sct:temp AddRecipe.Items[] if data storage hd.sct:temp AddRecipe.Result.id if data storage hd.sct:temp AddRecipe.Result.Count run function hd.sct:add.recipes/2
## レシピが追加出来なかったら
