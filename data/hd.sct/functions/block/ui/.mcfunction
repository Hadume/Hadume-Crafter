...
# @within function
#   hd.sct:block/set
#   hd.sct:sct/changed.items/recipe_book/change.page/return
...
## 
	execute if entity @s[tag=!HdSctRM] run function hd.sct:block/ui/sct
	execute if entity @s[tag=HdSctRM] run function hd.sct:block/ui/recipe_maker
## 
