...
## 
	...
	execute unless data entity @s data.Using.Recipe unless data storage hd.sct:temp ItemsCopy[{Slot:15b,tag:{HdSct:1b}}] if entity @s[tag=!HdSct.Recipe] run loot replace block ~ ~ ~ container.15 loot hd.sct:gui/air
