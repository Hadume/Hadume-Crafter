#> hd.sct:recipes/book/make/make/loop
#
# データを設定
#
...
## データを追加
	execute if data storage hd.sct:recipe_book NotYet[] run function hd.sct:recipes/book/make/make/if.not_yet
## 空白データを追加
...
## ループ
	execute if score $HdSct.Slot HdSct.Temp matches ..21 run function hd.sct:recipes/book/make/make/loop
