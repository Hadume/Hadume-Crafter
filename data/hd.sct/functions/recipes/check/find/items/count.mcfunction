#> hd.sct:recipes/check/find/items/count
#
# Countが同じか確認
#
...
## tagの確認
	execute if score $HdSct.Same.Recipe HdSct.Temp matches 0 if data storage hd.sct:temp ItemsCopy[-10].tag run function hd.sct:recipes/check/find/items/tag
	execute if score $HdSct.Same.Recipe HdSct.Temp matches 0 if data storage hd.sct:temp RecipesCopy[-1].Items[-10].tag unless data storage hd.sct:temp ItemsCopy[-10].tag run function hd.sct:recipes/check/find/items/tag
