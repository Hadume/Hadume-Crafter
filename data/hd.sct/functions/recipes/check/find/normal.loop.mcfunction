...
## ループ
	execute if data storage hd.sct:temp ItemsCopy[-10] if data storage hd.sct:temp RecipesCopy[-1].Items[-10] if score $HdSct.lib.Different HdSct.Temp matches 0 run function hd.sct:recipes/check/find/normal.loop
