...
## 
	function hd.sct:sct/changed.items/recipe_book/air
## 
	execute if data storage hd.sct:temp RecipesCopy[{tag:{HdSct:{Recipe:{Selected:1b}}}}] run function hd.sct:sct/changed.items/recipe_book/display.materials/reset.selected_recipe
## 
...
## Tagがあったら、Tagを代入
	execute if data storage hd.sct:temp RecipesCopy[-15].tag.HdSct.Recipe.Items[].Tag run function hd.sct:sct/changed.items/recipe_book/display.materials/tag/
## 
