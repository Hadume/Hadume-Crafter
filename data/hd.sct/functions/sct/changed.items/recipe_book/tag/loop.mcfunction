#> hd.sct:sct/changed.items/recipe_book/tag/loop
#
# アイテムを選択
#
# @within function hd.sct:sct/changed.items/recipe_book/tag/update
# @private
...
## データがあったら、ループ
	execute if data storage hd.sct:temp TagCopy[-10] run function hd.sct:sct/changed.items/recipe_book/tag/loop
