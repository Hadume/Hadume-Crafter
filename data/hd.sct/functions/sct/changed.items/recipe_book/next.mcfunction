...
## やっぱ、ページ作っちゃうも～～ん
	...
	execute if score $HdSct.Success HdSct.Temp matches 1 run data modify entity @e[predicate=hd.sct:storage,limit=1] data.Using.RecipeBook set from storage hd.sct:recipe_book _[-1].Data
## アイテム
