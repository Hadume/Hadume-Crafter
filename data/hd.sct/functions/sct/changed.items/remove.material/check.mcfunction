...
## 完成アイテムを重ねる
	execute store success score $HdSct.Compare HdSct.Temp run data modify storage hd.sct:temp ItemsCopy[{Slot:15b}] set from storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].HdSct.Using.Recipe.Result
## 素材アイテムを減らす
