...
# アイテムのCountを減らす
#
# @within function hd.sct:sct/changed.items/remove.material/as
# @private
...
## アイテムを減らさない
	...
	execute if predicate hd.sct:not.remove/_ run function hd.sct:sct/changed.items/remove.material/not.remove
## Countを減らして、代入
