...
## 
	...
	execute as @e[type=minecraft:armor_stand,tag=HdSctThis,distance=..0.001] run function hd.sct:sct/changed.items/shift.click/as
...
## 素材アイテムを減らす
	...
	execute as @e[type=minecraft:marker,tag=HdSctThis,distance=..0.001,limit=1] run function hd.sct:sct/changed.items/remove.material/main
## 完成アイテムSlotを直す
