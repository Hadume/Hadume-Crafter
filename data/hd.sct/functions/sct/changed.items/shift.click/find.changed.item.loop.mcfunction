...
## ループ
	execute if score $HdSct.Compared HdSct.Temp matches 0 if data storage hd.sct:temp InventoryCopy[-1] run function hd.sct:sct/changed.items/shift.click/find.changed.item.loop
