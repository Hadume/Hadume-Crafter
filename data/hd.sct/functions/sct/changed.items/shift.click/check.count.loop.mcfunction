#> hd.sct:sct/changed.items/shift.click/check.count.loop
#
...
## まだ確認してないアイテムがあったら、ループする
	execute if data storage hd.sct:temp Materials[-10] run function hd.sct:sct/changed.items/shift.click/check.count.loop
