...
## 
	...
	execute if data storage hd.sct:lib RemoveDisplay run data remove storage hd.sct:lib RemoveDisplay
	execute if data storage hd.sct:lib RemoveDamage run data remove storage hd.sct:lib RemoveDamage
	execute if data storage hd.sct:lib SameCount run data remove storage hd.sct:lib SameCount
## 
